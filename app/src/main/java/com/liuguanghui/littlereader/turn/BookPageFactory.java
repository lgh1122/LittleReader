...
public class BookPageFactory {
    ...
    public void openbook(String strFilePath) throws IOException {
		...
		*/
        ...
        fileInputStream = new FileInputStream(book_file);

        FileChannel fc= fileInputStream.getChannel();//new RandomAccessFile(book_file, "r").getChannel();
